...
<c:if test="${emptyStudentDetails == null}">	
<div class="container text-center my-4 position-relative">
	<form action="fetchUserDetails" method="post">
		<span class="font-weight-bold mr-2">Username :</span> <select name="username" class="py-1 px-2 mr-3" style="border: 1px solid black;border-radius:8px">
...
<c:if test="${emptyStudentDetails != null}">
	<h3 class="mt-4" style="text-align:center;">No student found</h3>
</c:if>
