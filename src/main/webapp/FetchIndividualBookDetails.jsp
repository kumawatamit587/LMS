...
<div class="container col-lg-8 my-5 font-weight-bold alert alert-warning" style="font-size:18px">
	<div class="container row">
		<div class="col-lg-5"><span class="text-danger">Book ID :</span> ${bookDetails.getBookid()}</div>
		<div class="col-lg-6"><span class="text-danger">Name :</span> ${bookDetails.getBookname()}</div>
	</div>
	<div class="container row">
		<div class="col-lg-5"><span class="text-danger">Author :</span> ${bookDetails.getAuthor()}</div>
		<div class="col-lg-6"><span class="text-danger">Pages :</span> ${bookDetails.getPages()}</div>
	</div>
	<div class="container row">
		<div class="col-lg-5"><span class="text-danger">Publisher :</span> ${bookDetails.getPublisher()}</div>
		<div class="col-lg-6"><span class="text-danger">Genre :</span> ${bookDetails.getGenre()}</div>
	</div>
	<div class="container row">
		<div class="col-lg-5"><span class="text-danger">Total Copies :</span> ${bookDetails.getTotalcopies()}</div>
		<div class="col-lg-6"><span class="text-danger">Available Copies :</span> ${bookDetails.getCopies()}</div>
	</div>
</div>

<c:if test="${emptyStudentHistory == null }">
	<table class="table table-striped container text-center">
	  <thead class="thead-dark">
		...
		<tbody>	
			<c:forEach items="${bookIssueBookHistory}" var="issueHistory">
				<tr>
...
<c:if test="${emptyStudentHistory != null }">
	<h3 style="text-align:center">Book has been never issued to anyone.</h3>
</c:if>
